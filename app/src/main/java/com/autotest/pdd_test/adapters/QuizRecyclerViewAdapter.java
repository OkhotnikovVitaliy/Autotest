...
public class QuizRecyclerViewAdapter extends RecyclerViewAdapter<List<TextView>> implements View.OnClickListener {
    ...
    public QuizRecyclerViewAdapter(List<ViewModel> items, int itemLayout, FragmentTest fragment) {
